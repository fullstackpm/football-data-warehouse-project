...
DROP TABLE IF EXISTS silver.competitions_clubs;
CREATE TABLE silver.competitions_clubs (
    club_id                             INTEGER,
    club_code                           TEXT,
    "name"                              TEXT,
...
DROP TABLE IF EXISTS silver.competitions_details;
CREATE TABLE silver.competitions_details (
    competition_id                      TEXT,
...
DROP TABLE IF EXISTS silver.competitions_countries;
CREATE TABLE silver.competitions_countries (
    country_id                          INTEGER,
    country_name                        TEXT,
    country_code                        TEXT,
    confederation                       TEXT,
...
DROP TABLE IF EXISTS silver.competitions_national_teams;
CREATE TABLE silver.competitions_national_teams (
...
DROP TABLE IF EXISTS silver.players_details;
CREATE TABLE silver.players_details (
    player_id                           INTEGER,
    first_name                          TEXT,
    last_name                           TEXT,
    "name"                              TEXT,
...
DROP TABLE IF EXISTS silver.players_valuations;
CREATE TABLE silver.players_valuations (
    player_id                           INTEGER,
    date                                TEXT,
    market_value_in_eur                 NUMERIC,
    current_club_name                   TEXT,
...
DROP TABLE IF EXISTS silver.players_transfers;
CREATE TABLE silver.players_transfers (
    player_id                           INTEGER,
    transfer_date                       TEXT,
...
DROP TABLE IF EXISTS silver.games_appearances;
CREATE TABLE silver.games_appearances (
    appearance_id                       TEXT,
    game_id                             INTEGER,
    player_id                           INTEGER,
...
DROP TABLE IF EXISTS silver.games_club_games;
CREATE TABLE silver.games_club_games (
    game_id                             INTEGER,
    club_id                             INTEGER,
    own_goals                           INTEGER,
    own_position                        TEXT,
...
DROP TABLE IF EXISTS silver.games_events;
CREATE TABLE silver.games_events (
    game_event_id                       TEXT,
    date                                TEXT,
    game_id                             INTEGER,
    "minute"                            INTEGER,
...
DROP TABLE IF EXISTS silver.games_lineups;
CREATE TABLE silver.games_lineups (
...
DROP TABLE IF EXISTS silver.games_details;
CREATE TABLE silver.games_details (
    game_id                             INTEGER,
    competition_id                      TEXT,
    season                              INTEGER,
    round                               TEXT,
