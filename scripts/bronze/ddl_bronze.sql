...
CREATE TABLE IF NOT EXISTS bronze.players_details (
	player_id INTEGER,
	first_name TEXT,
	last_name TEXT,
	"name" TEXT,
...
CREATE TABLE IF NOT EXISTS bronze.players_valuations (
	player_id INTEGER,
	date TEXT,
	market_value_in_eur NUMERIC,
	current_club_name TEXT,
...
CREATE TABLE IF NOT EXISTS bronze.players_transfers (
    player_id                           INTEGER,
    transfer_date                       TEXT,
...
CREATE TABLE IF NOT EXISTS bronze.games_appearances (
    appearance_id                       TEXT,
    game_id                             INTEGER,
    player_id                           INTEGER,
...
CREATE TABLE IF NOT EXISTS bronze.games_club_games (
    game_id                             INTEGER,
    club_id                             INTEGER,
    own_goals                           INTEGER,
    own_position                        TEXT,
...
CREATE TABLE IF NOT EXISTS bronze.games_events (
    game_event_id                       TEXT,
    date                                TEXT,
    game_id                             INTEGER,
    "minute"                            INTEGER,
...
CREATE TABLE IF NOT EXISTS bronze.games_lineups (
...
CREATE TABLE IF NOT EXISTS bronze.games_details (
    game_id                             INTEGER,
    competition_id                      TEXT,
    season                              INTEGER,
    round                               TEXT,
...
CREATE TABLE IF NOT EXISTS bronze.competitions_clubs (
    club_id                             INTEGER,
    club_code                           TEXT,
    "name"                              TEXT,
...
CREATE TABLE IF NOT EXISTS bronze.competitions_details (
    competition_id                      TEXT,
...
CREATE TABLE IF NOT EXISTS bronze.competitions_countries (
    country_id                          INTEGER,
    country_name                        TEXT,
    country_code                        TEXT,
    confederation                       TEXT,
...
CREATE TABLE IF NOT EXISTS bronze.competitions_national_teams (
